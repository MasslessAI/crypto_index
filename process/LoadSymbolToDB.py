...
def loadSingleSymbolToDB(req_dict,keyList):
	...
	print('Running Symbol %s, Period %s, on source %s' %(my_req_dict['symbol_id'],my_req_dict['period_id'],source))
    
	df= dg.data_gen(source, my_req_dict, keyList,write_to_file=False, returnDF=True)
